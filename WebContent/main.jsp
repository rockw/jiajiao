...
<script>
	document.getElementsByTagName('html')[0].setAttribute('id', 'js-1')
</script>
...
<body>
		...
		<section class="container_top">
			...
			<section class="container_bottom">
				...
				<section class="content_main2">
					...
					<li>		用戶名： <label for="username">rtyyy</label></li>
				
					<li>		邮 箱: <label for="email">klll</label></li>
					...
					<form action="">
					    <label>手机号 ：</label>
					    <input name="" type="text" value="1343443434" class="text_field3" />				  								
					</form>
				</section>
				<!--content_main2 End-->
	...
	<img src="photo/me.jpg" alt="上海鲜花港 - 郁金香" width="400" height="266" />
